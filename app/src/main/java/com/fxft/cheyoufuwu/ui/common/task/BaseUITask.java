...
import com.fxft.cheyoufuwu.common.util.NetUtil;
        ...
        if (NetUtil.hasNetwork(mContext)
            ...
            if (r == null) {
                if (TextUtils.isEmpty(errorMsg)){
                    errorMsg = mContext.getString(com.fxft.cheyoufuwu.R.string.time_out);
                }
            ...
            if (r == null) {
                if (TextUtils.isEmpty(errorMsg)){
                    errorMsg = mContext.getString(com.fxft.cheyoufuwu.R.string.data_search_result_nothing);
                }
