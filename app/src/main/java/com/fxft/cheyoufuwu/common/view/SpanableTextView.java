...
public class SpanableTextView extends TextView {
    ...
    public SpanableTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        SpanableTextView.DEFAULT_ABSOLUTE_TEXT_SIZE = (int) getTextSize();
    }
    ...
    */
     ...
     *
     * You create a Piece by using it's {@link com.fxft.cheyoufuwu.common.view.SpanableTextView.Piece.Builder}
     *
     */
