package com.fxft.cheyoufuwu.common.view.scrollview;
        ...
        if (mCallbacks != null) {
            switch (ev.getActionMasked()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    float diffY = ev.getY() - mPrevMoveEvent.getY();    //得到上下滑动的差值
                    mPrevMoveEvent = MotionEvent.obtainNoHistory(ev);   //复制，但是没有任何触摸记录
